...
orders <- fread("~/MEGA/PGBABI/00 Capstone Project/Dataset/orders.csv")
products <- fread("~/MEGA/PGBABI/00 Capstone Project/Dataset/products.csv")
departments <- fread("~/MEGA/PGBABI/00 Capstone Project/Dataset/departments.csv")
aisles <- fread("~/MEGA/PGBABI/00 Capstone Project/Dataset/aisles.csv")
opp <- fread("~/MEGA/PGBABI/00 Capstone Project/Dataset/order_products__prior.csv")
opt <- fread("~/MEGA/PGBABI/00 Capstone Project/Dataset/order_products__train.csv")
